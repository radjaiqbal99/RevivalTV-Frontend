...
const ProductsCarousel = () => {
  return (
    <div className="products-scrolling mt-[50px] mx-[30px] md:mx-auto max-w-[1600px] md:px-[50%] carousel:px-0 md:snap-x md:snap-mandatory md:overflow-x-scroll flex flex-col items-center md:flex-row gap-[50px]">
